    ...
    <div class="breakpoint-indicators">
      ...
      <div class="indicators-grid">
        <div class="indicator" :class="{ active: deviceStore.isXs }">
          ...
          <div class="indicator-range">{{ deviceStore.breakpoints.xs }}px - {{ deviceStore.breakpoints.sm - 1 }}px</div>
        ...
        <div class="indicator" :class="{ active: deviceStore.isSm }">
          ...
          <div class="indicator-range">{{ deviceStore.breakpoints.sm }}px - {{ deviceStore.breakpoints.md - 1 }}px</div>
        ...
        <div class="indicator" :class="{ active: deviceStore.isMd }">
          ...
          <div class="indicator-range">{{ deviceStore.breakpoints.md }}px - {{ deviceStore.breakpoints.lg - 1 }}px</div>
        ...
        <div class="indicator" :class="{ active: deviceStore.isLg }">
          ...
          <div class="indicator-range">{{ deviceStore.breakpoints.lg }}px - {{ deviceStore.breakpoints.xl - 1 }}px</div>
        ...
        <div class="indicator" :class="{ active: deviceStore.isXl }">
          ...
          <div class="indicator-range">{{ deviceStore.breakpoints.xl }}px - {{ deviceStore.breakpoints.xxl - 1 }}px</div>
    ...
    <div class="utility-methods">
      ...
      <div class="methods-grid">
        ...
        <div class="method-demo">
          ...
          <div class="method-results">
            <div class="method-result" v-for="bp in breakpointNames" :key="`up-${bp}`">
              ...
              <span class="method-value" :class="{ true: deviceStore.isBreakpointUp(bp), false: !deviceStore.isBreakpointUp(bp) }">
        ...
        <div class="method-demo">
          ...
          <div class="method-results">
            <div class="method-result" v-for="bp in breakpointNames" :key="`down-${bp}`">
              ...
              <span class="method-value" :class="{ true: deviceStore.isBreakpointDown(bp), false: !deviceStore.isBreakpointDown(bp) }">
        ...
        <div class="method-demo">
          ...
          <div class="method-results">
            <div class="method-result" v-for="range in breakpointRanges" :key="`between-${range.min}-${range.max}`">
              <span class="method-call">isBreakpointBetween('{{ range.min }}', '{{ range.max }}')</span>
              <span class="method-value" :class="{ true: deviceStore.isBreakpointBetween(range.min, range.max), false: !deviceStore.isBreakpointBetween(range.min, range.max) }">
...
.breakpoint-badge {
  ...
  &.bp-xs { background: #e74c3c; }
  &.bp-sm { background: #f39c12; }
  &.bp-md { background: #f1c40f; color: #2c3e50; }
  &.bp-lg { background: #27ae60; }
  &.bp-xl { background: #3498db; }
  &.bp-xxl { background: #9b59b6; }
}
