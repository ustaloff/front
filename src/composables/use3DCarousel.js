...
export const use3DCarousel = (options = {}) => {
    ...
    const defaults = {
        ...
        maxVisibleAngle: Math.PI / 1.8,  // Максимальный угол видимости (в радианах). Определяет, насколько широко будут распределены видимые слайды по окружности. Диапазон от 0 до Math.PI (0° до 180°). Меньшие значения создают более узкую карусель, большие - более широкую.
